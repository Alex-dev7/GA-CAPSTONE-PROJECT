...
const posts = await getData()
  ...
  return (
    <>
      <main className="">
        <div>
          <h1 className="w-fit translate-y-3 mx-auto px-4 bg-white dark:bg-[#121212] dark:text-white text-2xl font-semibold text-gray-600">
            Feed
          </h1>
            ...
            ? posts.map((post: Post) => (
                <div key={post.id} className="group">
                  <div className="flex flex-col relative w-full drop-shadow-xl group-hover:scale-105 transition-transform duration-200 ease-out">
                    ...
                    <div className="absolute  text-white bottom-0 w-full bg-opacity-50 bg-black group-hover:-translate-y-16 group-hover:bg-opacity-80 transition-all duration-200 ease-out rounded drop-shadow-lg p-5 flex  justify-between">
                  ...
                  <div className="mt-5 relative">
                    <Link
                      ...
                      className="text-lg p-6 underline font-bold uppercase hover:text-gray-400"
                    >
                      {post?.title}
                    </Link>
